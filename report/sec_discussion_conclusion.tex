...
median window span is 7.60~\AA{} and the median radius of gyration is 3.06~\AA{}, and only
26.1\% of windows are wider than 10~\AA{}. Consecutive sites do form compact local
...
129 to 27 and the pockets that fail at all drop from 31 to 14; they disappear entirely
for the residues whose shape is fixed. The ones left are on
...
windows turn out to be compact patches, with a median span of 7.60~\AA{} and a radius of
gyration of 3.06~\AA{}, so their local geometry is largely preserved and the descriptor
